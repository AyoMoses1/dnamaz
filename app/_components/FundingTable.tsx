...
interface Customer {
  ...
  accountType: "Account" | "Request";
  date: string;
  investments: string;
}

const FundingTable: FC = () => {
  const [selectedAccountType, setSelectedAccountType] = useState<"Account" | "Request" | "All">("All");
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="bg-gray-100 text-black p-1 rounded-lg flex gap-1 w-72">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md ${selectedAccountType === "Account" ? "bg-white" : ""}`}
            >
              Account
            </button>
            <button
              onClick={() => setSelectedAccountType("Request")}
              className={`px-4 py-2 rounded-md ${selectedAccountType === "Request" ? "bg-white" : ""}`}
            >
              Request
            </button>
          </div>
